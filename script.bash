...
for ((month=1; month<=$NUM_MONTHS; month++)); do
    ...
    # Loop through each week in the month
        ...
        mkdir -p "Month$month/Week$week/Day$Day/task"
        ...
        touch "Month$month/Week$week/Day$Day/task/README.md"
        ...
        echo "task of the Day" >> "Month$month/Week$week/Day$Day/task/README.md"
        done
